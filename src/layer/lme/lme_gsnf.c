...
//
//
// static l_err parse_gsg_pkt(buffer_t *pdu, gsg_pkt_t **gsnf_pkg_ptr, lme_as_man_t **as_man) {
//     pb_stream gsnf_pbs;
//     zero(&gsnf_pbs);
...
//     }
//
//     if (has_lme_as_enode(gsnf_pkg->AS_SAC) == FALSE) {
//         return LD_ERR_INVALID;
//     }
//
//     *as_man = (lme_as_man_t *) get_lme_as_enode(gsnf_pkg->AS_SAC);
//
...
//             if (has_lme_as_enode(init_pkt->AS_SAC) == FALSE && lme_map_has_ua(init_pkt->UA) == FALSE) {
//                 set_lme_as_enode(init_as_man(init_pkt->AS_SAC, init_pkt->UA, lme_layer_objs.GS_SAC, LD_AUTHC_G0));
//             } else {
//                 return LD_ERR_INTERNAL;
//             }
//
//             if ((as_man = (lme_as_man_t *) get_lme_as_enode(init_pkt->AS_SAC)) == NULL) {
...
//             if ((as_man = (lme_as_man_t *) get_lme_as_enode(gsnf_pkt->AS_SAC)) == NULL) {
//                 log_warn("AS MAN is NULL");
//                 return LD_ERR_NULL;
//             }
...
//                 delete_lme_as_node_by_sac(gsnf_pkt->AS_SAC, clear_as_man);
//             }
//
//             free(gsnf_pkt);
//             break;
...
//                     }
//
//                     if (has_lme_as_enode(resp.SAC) == FALSE) {
//                         set_lme_as_enode(init_as_man(resp.SAC, gsnf_sac_pkg->UA, lme_layer_objs.GS_SAC, LD_AUTHC_G0));
//                     }
//
